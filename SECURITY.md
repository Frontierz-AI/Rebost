...
Those requests send a query string, IP address, and the user agent `Rebost/0.9.0 (local-first open-source desktop AI; https://github.com/Frontierz-AI/Rebost)`. They do not include Shelf documents.
