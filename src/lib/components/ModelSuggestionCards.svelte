  ...
  <div class="@container">
    ...
    <ul class="mt-3 grid grid-cols-1 gap-3 @min-[28rem]:grid-cols-2" role="list">
      {#each suggestions as rec, index (rec.reference)}
        ...
        <li
          class="flex flex-col justify-between gap-4 rounded-xl bg-white p-4 ring-1
            {featured ? 'ring-amber-450/70' : 'ring-navy-950/10'}"
        >
          <div class="flex min-w-0 flex-col gap-3">
            ...
            <dl class="grid grid-cols-3 gap-x-3 text-[0.6875rem]">
              ...
              <div>
                ...
                <dd class="mt-0.5 tabular-nums text-ink-soft">
