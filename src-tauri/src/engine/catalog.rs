...
impl MachineProfile {
    pub fn detect(data_dir: &std::path::Path) -> Self {
        ...
        Self {
            ...
            accelerator: super::pin::current_engine_pin()
...
pub const CATALOG: &[CatalogEntry] = &[
    ...
    CatalogEntry {
        ...
        license: "Apache-2.0",
        released: "2026-08",
        blurb: "Meta 30B. Needs a machine with real RAM.",
    },
    CatalogEntry {
        name: "Gemma 4 31B",
        family: "Gemma",
        ...
        license: "Apache-2.0",
        released: "2026-04",
        blurb: "Google 31B. Stronger Gemma; large download.",
    },
    CatalogEntry {
        name: "Gemma 4 12B",
        family: "Gemma",
        ...
        license: "Apache-2.0",
        released: "2026-05",
        blurb: "Google 12B. Documents and chat on 24–32 GB machines.",
    },
    CatalogEntry {
        name: "gpt-oss 20B",
        family: "GPT",
    ...
    CatalogEntry {
        ...
        license: "Apache-2.0",
        released: "2026-03",
        blurb: "Gemma E4B. Sized for 16 GB of RAM.",
    },
    CatalogEntry {
        ...
        license: "Apache-2.0",
        released: "2025-12",
        blurb: "Ministral 14B. Comfortable with long documents.",
    },
    CatalogEntry {
        name: "Ministral 3 8B",
        family: "Mistral",
        ...
        license: "Apache-2.0",
        released: "2025-12",
        blurb: "Ministral 8B. Quicker replies.",
    },
    CatalogEntry {
        name: "Ministral 3 3B",
        family: "Mistral",
        ...
        license: "Apache-2.0",
        released: "2025-12",
        blurb: "Ministral 3B. Fits when RAM is tight.",
    },
    CatalogEntry {
        name: "Qwen3.5 2B",
        family: "Qwen",
        ...
        license: "Apache-2.0",
        released: "2026-01",
        blurb: "Qwen 2B. For trying Rebost without waiting.",
    },
    CatalogEntry {
        name: "Granite 4.1 3B",
        family: "Granite",
        ...
        license: "Apache-2.0",
        released: "2026-04",
        blurb: "IBM Granite 3B. Small file, short answers.",
    },
    CatalogEntry {
        name: "Gemma 3 1B",
        family: "Gemma",
        ...
        license: "Gemma",
        released: "2025-03",
        blurb: "Gemma 1B. Smallest catalog row; installs in a minute.",
    },
];
...
fn pick_index(profile: &MachineProfile) -> usize {
    CATALOG
        ...
        .or_else(|| CATALOG.iter().rposition(|entry| is_default_work(entry)))
