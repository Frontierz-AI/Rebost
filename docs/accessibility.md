...
Keyboard-first notes for VoiceOver on macOS (verified against Rebost 0.8.11, Tauri 2 webview). Windows Narrator has not been verified. Gaps are listed at the end.
