...
Keyboard-first notes for VoiceOver on macOS (verified against Rebost 0.7.0, Tauri 2 webview). Windows Narrator has not been verified. Gaps are listed at the end.
